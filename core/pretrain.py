...
args_dict = dict(
    data_dir='/export/home/0usmanov/data/conceptnet_df_w', # path for data files
...
def generate_data():
    df = pd.read_csv('/export/home/0usmanov/data/masked_conceptnet_weighted.csv')
    temp_df = df
    ...
    train_dataset.to_csv('/export/home/0usmanov/data/conceptnet_df_w/train.csv')
    val_dataset.to_csv('/export/home/0usmanov/data/conceptnet_df_w/val.csv')
    test_dataset.to_csv('/export/home/0usmanov/data/conceptnet_df_w/test.csv')

if __name__ == "__main__":
    set_seed(42)
    args = argparse.Namespace(**args_dict)

    exp_type = "test" # weighted, random
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename=f"{args.model_variant}_{exp_type}_pretrainer_model_{local_start_time_str}", 
        monitor="val_loss", mode="min", save_top_k=1
    )
    logger = TensorBoardLogger("/export/home/0usmanov/project/output/conceptnet/training_logs", name=f"{args.model_variant}_{exp_type}_pretrainer_model_{local_start_time_str}")
